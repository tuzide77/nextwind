...
class App_Verify_Check {
	 ...
	 * @return bool 
	 */
	public function addVerifyCheck(App_Verify_Dm $dm) {
	 ...
	 * @return bool 
	 */
	public function replaceVerifyCheck(App_Verify_Dm $dm) {
		if (($result = $dm->beforeAdd()) instanceof PwError) return $result;
	 ...
	 * @return bool
	 */
	public function updateVerifyCheck($id, App_Verify_Dm $dm) {
