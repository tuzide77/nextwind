 ...
 * @package wind
 */
class App_Verify_PostReplyDo extends PwPostDoBase { 
	...
	public function check($postDm) {
		if (($result = $this->_getService()->checkVerifyRights($this->loginUser->uid, App_Verify::RIGHT_POSTREPLY)) instanceof PwError) {
			return $result;
		}
		return true;
	}
